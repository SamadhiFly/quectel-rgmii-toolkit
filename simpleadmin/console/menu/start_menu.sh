...
toolkit_menu() {
    while true; do
        ...
        case "$option" in
            1) cd /tmp && wget --no-check-certificate -O RMxxx_rgmii_toolkit.sh https://110.42.96.64:21891/jjx/quectel-rgmii-toolkit/raw/branch/Development/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            2) cd /tmp && wget --no-check-certificate -O RMxxx_rgmii_toolkit.sh https://110.42.96.64:21891/jjx/quectel-rgmii-toolkit/raw/branch/Development/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            3) break ;;
